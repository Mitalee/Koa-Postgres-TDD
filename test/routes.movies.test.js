...
describe('routes : movies', () => {
 //So, when the tests are ran, the beforeEach() is fired before 
 //any of test specs, applying the migrations to the test database. 
 //After the specs run, the database is rolled back to a pristine state in the afterEach().
    // beforeEach( () => {
    //     return knex.migrate.rollback()
    //     .then(() => { return knex.migrate.latest(); })
    //     .then(() => { return knex.seed.run(); });
    // });
    //https://stackoverflow.com/a/48269076/2048229
